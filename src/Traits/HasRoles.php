...
trait HasRoles
{
     ...
     * @return array
     * @author brady
     * Time: 2021-08-18 18:03:48
     */
    public function getRoleIds(){
        return Enforcer::getRolesForUser($this->user_name);
    }

    /**
     * @return string
     * @author brady
     * Time: 2021-08-18 18:03:53
     */
    public function getRoleId(){
        $ids = Enforcer::getRolesForUser($this->user_name);
    ...
    public function getRole(){
        ...
        return $this->getStoredRole((int)$role_ids[0]);
    }
